...
china = {
    '北京': {
        '通州区': {
            '梨园镇': ['九棵树村', '李老公庄村', '梨园村', '砖厂村', '公庄村', '大马庄村', '高楼金村'],
            '永顺镇': [],
            '宋庄镇': [],
            '漷县镇': [],
            '张家湾镇': [],
    ...
    if user_input1 == 'q':
        ...
        while flag:
            ...
            if user_input2 == 'q':
                ...
                valages = list(china[choosen1][choosen2].keys())
                ...
                while flag:
                    ...
                    if user_input3 == 'q':
                        ...
                        break
                    elif user_input3 not in [str(i) for i in range(len(valages))]:
                        print("\033[31;1m请输入有效操作\033[0m...")
                        continue
                    else:
                        choosen3 = valages[int(user_input3)]
                        countrys = china[choosen1][choosen2][choosen3]

                        while flag:
                            for i, option in enumerate(countrys):
                                print('[{no:d}] : {option:s}'.format(no=i, option=option))
                            user_input4 = input(tips)
                            if user_input4 == 'q':
                                flag = False
                                break
                            elif user_input4 == 'b':
