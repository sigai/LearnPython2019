...
ss=_b.closest("div.datagrid-Template");
if(!ss.length){
ss=dc.view;
}
}
...
_24.children(":not(.datagrid-Template,.datagrid-mask,.datagrid-mask-msg)").each(function(){
...
var dg=$(e.target).closest("div.datagrid-Template").children(".datagrid-f");
