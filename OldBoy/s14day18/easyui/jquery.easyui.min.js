...
ss=_64f.closest("div.datagrid-Template");
if(!ss.length){
ss=dc.view;
}
}
...
wrap.children(":not(.datagrid-Template,.datagrid-mask,.datagrid-mask-msg)").each(function(){
